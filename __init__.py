...
# code is the installed PEP 420 namespace package tap_plugin.compliance_core
# (tap_plugin/compliance_core/). This exists only so pytest names this project dir's
# tests fully-qualified as plugins.compliance_core.tests.* during the monorepo
